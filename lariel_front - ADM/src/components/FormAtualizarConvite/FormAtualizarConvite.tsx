            ...
            <form className="text-[var(--color-font-black)]" onSubmit={onSubmit}>
                ...
                <div className="mt-5">
                    <div className="flex justify-center">
                        <button className="bg-gradient-to-br text-white from-[var(--color-2)] via-blue-300 to-[var(--color-2)] cursor-pointer rounded-xl border-2 border-[var(--color-font-black)] font-medium w-20 md:w-25 h-13 md:h-12" type="submit">Atualizar</button>
                    </div>
                </div>
            </form>
        </div>
